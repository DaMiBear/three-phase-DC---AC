...
//	while(1)
//	{  // OLED_ShowString(0,0,"u = 0.00");
//		OLED_ShowNum(32,0,1,1,12);            //??   ??   ??   ??
//        OLED_ShowNum(48,0,2,1,12);
//        OLED_ShowNum(56,0,3,1,12);
//        delay(10);
//    
//	}
//  
 ...
 void GPIO_I()
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOC|RCC_APB2Periph_GPIOD,ENABLE);//使能B端口
	...
	GPIO_InitStruct.GPIO_Speed=GPIO_Speed_50MHz;			//最高输出速率50Mhz
	GPIO_Init(GPIOD,&GPIO_InitStruct);          //初始化PB端口
